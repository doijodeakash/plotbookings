...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <form id="form1" runat="server">
            ...
            <!-- Bootstrap Modal -->
            <div class="modal fade mt-5 " id="myModal" tabindex="-1" style="background-color: cyan;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding: 100px">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body mt-2">
                            ...
                            <asp:TextBox type="text" ID="txtplotno" class="form-control" runat="server" />

                            <asp:Label runat="server"><i class="fa fa-area-chart"></i>Square Feet</asp:Label>

                            <asp:TextBox type="text" ID="txtsqft" class="form-control" runat="server" />

                            <asp:Label runat="server"><i class="fa fa-check-square"></i>Status</asp:Label>

                            <asp:TextBox type="text" ID="txtstatus" class="form-control" runat="server" />
                        </div>
                        <div class="modal-footer">
                            <asp:Button Text="Close" class="btn btn-secondary" data-dismiss="modal" runat="server" Style="width: 100px" />
                            <asp:Button Text="Save changes" class="btn btn-primary" runat="server" Style="width: 100px" OnClick="btnaddplots_click" ID="btn_saves" />
                        </div>
                    </div>
                </div>
            </div>
