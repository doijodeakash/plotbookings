...
<body>
    ...
    <form id="form1" runat="server">
        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModalLong">See Layout</button>
        <table style="margin-top:30px;" class="w-100">
            ...
            <Columns>
                ...
                <asp:CommandField ShowSelectButton="True" ControlStyle-CssClass="btn btn-info btn-lg btn btn-primary" HeaderText="SELECT PLOT" />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mt-2" >
          ...
          <asp:TextBox type="text" ID="txtcname" class="form-control" runat="server" />

          <asp:Label  runat="server" ><i class="fa fa-phone-square"></i>Mobile No.</asp:Label>

          <asp:TextBox type="text" ID="txtcontact" class="form-control" runat="server" />
      </div>
      <div class="modal-footer">
          <asp:Button Text="Close" class="btn btn-secondary" data-dismiss="modal" runat="server" style="width:100px" />
          <asp:Button Text="Save changes" class="btn btn-primary" runat="server" style="width:100px" OnClick="btn_Click" ID="btn_saves"/>
      </div>
    </div>
  </div>
</div>
